...
{
    private static function tokens(): OidcTokens
    {
        $raw = new \stdClass();
    ...
    public function testEnsureUserExistsCreatesUserIfNotFound(): void
    {
        ...
        $provider = new OidcUserProvider($repo, $em, new \App\Security\OidcAccessGuard('', $em), new \App\Application\Service\Avatar\AuthentikAvatarFetcher(new \Symfony\Component\HttpClient\MockHttpClient(), $this->createStub(\App\Application\Storage\AttachmentStorageInterface::class), $em), 'admin_spm');
